...
#ifndef hahaha_processing_unit_form_base_baseH
#define hahaha_processing_unit_form_base_baseH
//---------------------------------------------------------------------------
#pragma once
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class Thahaha_form_processing_unit_base_base : public TForm
{
...
public:		// User declarations
	__fastcall Thahaha_form_processing_unit_base_base(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE Thahaha_form_processing_unit_base_base *hahaha_form_processing_unit_base_base;
//---------------------------------------------------------------------------
#endif
