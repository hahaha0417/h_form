...
#ifndef hahaha_processing_unit_form_strategy_imageH
#define hahaha_processing_unit_form_strategy_imageH
//---------------------------------------------------------------------------
#pragma once
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class Thahaha_form_processing_unit_strategy_image : public TForm
{
...
public:		// User declarations
	__fastcall Thahaha_form_processing_unit_strategy_image(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE Thahaha_form_processing_unit_strategy_image *hahaha_form_processing_unit_strategy_image;
//---------------------------------------------------------------------------
#endif
