...
#else
	#pragma resource "hahaha_popup_view_popup_form_item.dfm"
#endif
	...
	: TForm(Owner)
{
    ...
    item_rect_text_box->BorderStyle = bsNone;
    item_rect_image_box->BorderStyle = bsNone;
...
void __fastcall Thahaha_form_popup_view_popup_item::button_add_rect_textClick(TObject *Sender)

{
    ...
    item_rect_text_box->Visible = true;
    item_rect_text_box->Width++;
    ha::Structure_Main_->Form_Popup_View_Popup_->View_Name->Text = L"文字";

    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Base->Caption = L"ha";
    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Region->Caption = L"矩形";
    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Strategy->Caption = L"文字";
    ...
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Factory_Strategy_ = ha_def::factory_processing_unit_strategy::HA;
    ...
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Strategy_ = ha_def::processing_unit_strategy::TEXT;
}
//---------------------------------------------------------------------------

void __fastcall Thahaha_form_popup_view_popup_item::button_add_rect_imageClick(TObject *Sender)

{
    ...
    item_rect_image_box->Visible = true;
    item_rect_image_box->Width++;
    ha::Structure_Main_->Form_Popup_View_Popup_->View_Name->Text = L"圖片";

    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Base->Caption = L"ha";
    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Region->Caption = L"矩形";
    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Strategy->Caption = L"圖片";

    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Factory_Base_ = ha_def::factory_processing_unit_base::HA;
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Factory_Region_ = ha_def::factory_processing_unit_region::HA;
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Factory_Strategy_ = ha_def::factory_processing_unit_strategy::HA;

    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Base_ = hahaha::hahaha_define_processing_unit_base::BASE;
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Region_ = hahaha::hahaha_define_processing_unit_region::RECTANGLE;
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Strategy_ = hahaha::hahaha_define_processing_unit_strategy::IMAGE;
}
//---------------------------------------------------------------------------
