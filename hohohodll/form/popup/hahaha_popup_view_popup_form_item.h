...
__published:	// IDE-managed Components
	...
	TLabel *title_name;
	TScrollBox *box_item;
	TButton *button_add_rect_text;
	TPageControl *PageControl1;
	TTabSheet *TabSheet1;
	TTabSheet *TabSheet2;
	TScrollBox *ScrollBox1;
	TScrollBox *ScrollBox2;
	TScrollBox *item_rect_text_box;
	TImage *pic_processing_unit_icon_rect_text;
	TImage *pic_processing_unit_sketch_rect_text;
	TMemo *processing_unit_content_rect_text;
	TButton *button_add_rect_image;
	TScrollBox *item_rect_image_box;
	TImage *pic_processing_unit_icon_rect_image;
	TImage *pic_processing_unit_sketch_rect_image;
	TMemo *processing_unit_content_rect_image;
	...
	void __fastcall button_add_rect_textClick(TObject *Sender);
	void __fastcall button_add_rect_imageClick(TObject *Sender);
