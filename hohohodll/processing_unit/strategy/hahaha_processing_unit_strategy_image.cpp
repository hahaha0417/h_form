...
#include "hahaha_processing_unit_strategy_image.h"
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_image::hahaha_processing_unit_strategy_image()
{
	Reset();
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_image::hahaha_processing_unit_strategy_image(const hahaha_processing_unit_strategy_image& hpusi)
{
    Reset();
    hahaha::hahaha_processing_unit_strategy_image::Copy(hpusi);
	Copy(hpusi);
}
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_image::hahaha_processing_unit_strategy_image(hahaha_processing_unit_strategy_image&& hpusi) noexcept
{
    hahaha::hahaha_processing_unit_strategy_image::Move(std::move(hpusi));
    Move(std::move(hpusi));
}
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_image& hahaha_processing_unit_strategy_image::operator=(const hahaha_processing_unit_strategy_image& hpusi)
{
    hahaha::hahaha_processing_unit_strategy_image::Copy(hpusi);
	Copy(hpusi);
...
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_image& hahaha_processing_unit_strategy_image::operator=(hahaha_processing_unit_strategy_image&& hpusi) noexcept
{
    hahaha::hahaha_processing_unit_strategy_image::Move(std::move(hpusi));
    Move(std::move(hpusi));
...
//---------------------------------------------------------------------------
void hahaha_processing_unit_strategy_image::Copy(const hahaha_processing_unit_strategy_image& hpusi)
{

}
//---------------------------------------------------------------------------
void hahaha_processing_unit_strategy_image::Move(hahaha_processing_unit_strategy_image&& hpusi) noexcept
{
    File_Name_ = std::move(hpusi.File_Name_);

    Message_Create_ = std::move(hpusi.Message_Create_);


    Ratio_Fix_ = hpusi.Ratio_Fix_;
    Direction_ = hpusi.Direction_;
    Is_Load_Bitmap_ = hpusi.Is_Load_Bitmap_;

    Bitmap_Load_ = std::move(hpusi.Bitmap_Load_);
    Bitmap_ = std::move(hpusi.Bitmap_);
    Bitmap_Thumbnail_ = std::move(hpusi.Bitmap_Thumbnail_);

}
//---------------------------------------------------------------------------
int hahaha_processing_unit_strategy_image::Reset()
{
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Set_Parameter()
{
    ha::Form_Processing_Unit_Strategy_Image_->Is_Update = true;
    ha::Form_Processing_Unit_Strategy_Image_->text_image_path->Text = File_Name_.c_str();
    ha::Form_Processing_Unit_Strategy_Image_->check_fix_ratio->Checked = Ratio_Fix_;
    ha::Form_Processing_Unit_Strategy_Image_->combo_box_direction->ItemIndex = (int)Direction_;

    ha::Form_Processing_Unit_Strategy_Image_->Is_Update = false;
    return halib_def::result::SUCCESS;
}
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Get_Parameter()
{
    ha::Form_Processing_Unit_Strategy_Image_->Is_Update = true;
    if(File_Name_ == L"" || File_Name_ != ha::Form_Processing_Unit_Strategy_Image_->text_image_path->Text.c_str())
    {
        Is_Load_Bitmap_ = false;
    }
    File_Name_ = ha::Form_Processing_Unit_Strategy_Image_->text_image_path->Text.c_str();

    Ratio_Fix_ = ha::Form_Processing_Unit_Strategy_Image_->check_fix_ratio->Checked;
    Direction_ = (ha_def::processing_unit_strategy_direction)ha::Form_Processing_Unit_Strategy_Image_->combo_box_direction->ItemIndex;
...
halib_def::image_view_result hahaha_processing_unit_strategy_image::On_Mouse_Down_Design(halib::image_view& image_view,
    TObject *Sender,
    TMouseButton Button,
    TShiftState Shift,
    int X,
...
halib_def::image_view_result hahaha_processing_unit_strategy_image::On_Mouse_Move_Design(halib::image_view& image_view,
    TObject *Sender,
    TShiftState Shift,
    int X,
    int Y
...
halib_def::image_view_result hahaha_processing_unit_strategy_image::On_Mouse_Up_Design(halib::image_view& image_view,
    TObject *Sender,
    TMouseButton Button,
    TShiftState Shift,
    int X,
...
halib_def::image_view_result hahaha_processing_unit_strategy_image::On_Paint_Begin(halib::image_view& image_view)
{
    Thahaha_image_view_form* form_ = (Thahaha_image_view_form*)image_view.Form_Image_View_;
...
halib_def::image_view_result hahaha_processing_unit_strategy_image::On_Paint_Design(halib::image_view& image_view)
{
    Thahaha_image_view_form* form_ = (Thahaha_image_view_form*)image_view.Form_Image_View_;
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Prepare_Node(
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Prepare_Attribute(
    hahahalib::hahaha_parameter_deal_xml& xml,
    std::vector<std::wstring>& node_names,
    std::vector<std::wstring>& node_names_target,
    hahahalib::hahaha_parameter_deal_xml_node& root,
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Prepare_Value(
    hahahalib::hahaha_parameter_deal_xml& xml,
    std::vector<std::wstring>& node_names,
    std::vector<std::wstring>& node_names_target,
    hahahalib::hahaha_parameter_deal_xml_node& root,
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Prepare(
    hahahalib::hahaha_parameter_deal_xml& xml,
    std::vector<std::wstring>& node_names,
    hahahalib::hahaha_parameter_deal_xml_node& root
)
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Mapping(
    hahahalib::hahaha_parameter_deal_xml& xml,
    std::vector<std::wstring>& node_names,
    hahahalib::hahaha_parameter_deal_xml_node& root
)
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Initial()
{
    halib_def::result result = halib_def::result::SUCCESS;
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_image::Load_Initial()
{
    halib_def::result result = halib_def::result::SUCCESS;
