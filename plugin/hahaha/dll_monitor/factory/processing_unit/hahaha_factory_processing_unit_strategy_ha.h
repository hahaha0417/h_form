...
class hahaha_processing_unit_strategy_monitor;
//---------------------------------------------------------------------------
...
public:
    ...
    std::map<hahaha::hahaha_processing_unit_strategy_monitor*, std::unique_ptr<hahaha::hahaha_processing_unit_strategy_monitor>> Pu_Strategy_Monitor_;
public:
