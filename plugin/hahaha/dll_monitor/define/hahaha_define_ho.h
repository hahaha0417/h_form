...
class Thahaha_form_processing_unit_strategy_monitor;
//---------------------------------------------------------------------------
namespace hahaha
{
//---------------------------------------------------------------------------
...
extern std::unique_ptr<Thahaha_form_processing_unit_strategy_monitor> Form_Processing_Unit_Strategy_Monitor_;
