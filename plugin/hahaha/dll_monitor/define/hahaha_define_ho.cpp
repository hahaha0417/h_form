...
std::unique_ptr<Thahaha_form_processing_unit_strategy_monitor> Form_Processing_Unit_Strategy_Monitor_;
//---------------------------------------------------------------------------
// 跑计
//---------------------------------------------------------------------------
...
int Initial()
{
    ...
    if(Form_Processing_Unit_Strategy_Monitor_.get() == NULL)
    {
        Form_Processing_Unit_Strategy_Monitor_.reset(new Thahaha_form_processing_unit_strategy_monitor(NULL));
    }
    ...
    Form_Processing_Unit_Strategy_Monitor_->main_box->Parent = ha::Structure_Main_->Form_Popup_View_Popup_Setting_->box_processing_unit_strategy;
    Form_Processing_Unit_Strategy_Monitor_->main_box->Align = alClient;
    Form_Processing_Unit_Strategy_Monitor_->main_box->Visible = false;
    //
    // 矪瞶把计ノ
    ha::Structure_Main_->Form_Popup_View_Popup_Setting_->Form_Strategys_[ha_def::processing_unit_strategy::PLUGIN_HAHAHA_MONITOR] = Form_Processing_Unit_Strategy_Monitor_.get();


    // ち传陪ボノ

    ha::Structure_Main_->Form_Popup_View_Popup_Setting_->Page_Strategys_[ha_def::processing_unit_strategy::PLUGIN_HAHAHA_MONITOR] = Form_Processing_Unit_Strategy_Monitor_->main_box;
