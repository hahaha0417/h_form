...
__published:	// IDE-managed Components
	...
	TLabel *title_name;
	TScrollBox *box_item;
	TButton *button_add_rect_monitor;
	TPageControl *PageControl1;
	TTabSheet *TabSheet1;
	TTabSheet *TabSheet2;
	TScrollBox *ScrollBox1;
	TScrollBox *ScrollBox2;
	TScrollBox *item_rect_monitor_box;
	TImage *pic_processing_unit_icon_rect_monitor;
	TImage *pic_processing_unit_sketch_rect_monitor;
	TMemo *processing_unit_content_rect_monitor;
	...
	void __fastcall button_add_rect_monitorClick(TObject *Sender);
