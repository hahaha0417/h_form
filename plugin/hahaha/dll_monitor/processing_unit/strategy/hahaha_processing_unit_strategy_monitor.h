...
#ifndef hahaha_processing_unit_strategy_monitorH
#define hahaha_processing_unit_strategy_monitorH
//---------------------------------------------------------------------------
#pragma once
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
...
class hahaha_processing_unit_strategy_monitor : public hahaha::hahaha_processing_unit_strategy
{
public:
	hahaha_processing_unit_strategy_monitor();
	~hahaha_processing_unit_strategy_monitor();

	hahaha_processing_unit_strategy_monitor(const hahaha_processing_unit_strategy_monitor& hpusm);
    hahaha_processing_unit_strategy_monitor(hahaha_processing_unit_strategy_monitor&& hpusm) noexcept;
	hahaha_processing_unit_strategy_monitor& operator=(const hahaha_processing_unit_strategy_monitor& hpusm);
    hahaha_processing_unit_strategy_monitor& operator=(hahaha_processing_unit_strategy_monitor&& hpusm) noexcept;
	void Copy(const hahaha_processing_unit_strategy_monitor& hpusm);
    void Move(hahaha_processing_unit_strategy_monitor&& hpusm) noexcept;
public:
	int Reset();
