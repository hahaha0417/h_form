...
__published:	// IDE-managed Components
	...
	TLabel *title_name;
	TScrollBox *box_item;
	TButton *button_add_rect_webcam;
	...
	TImage *pic_processing_unit_icon_rect_webcam;
	TImage *pic_processing_unit_sketch_rect_webcam;
	TMemo *processing_unit_content_rect_webcam;
	...
	void __fastcall button_add_rect_webcamClick(TObject *Sender);
