...
void __fastcall Thahaha_form_popup_view_popup_item::button_add_rect_webcamClick(TObject *Sender)

{
    ...
    ha::Structure_Main_->Form_Popup_View_Popup_->View_Name->Text = L"網路攝影機";

    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Base->Caption = L"plugin_hahaha_WEBCAM";
    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Region->Caption = L"矩形";
    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Strategy->Caption = L"網路攝影機";
    ...
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Factory_Strategy_ = ha_def::factory_processing_unit_strategy::PLUGIN_HAHAHA_WEBCAM;
    ...
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Strategy_ = ha_def::processing_unit_strategy::PLUGIN_HAHAHA_WEBCAM;
}
//---------------------------------------------------------------------------
