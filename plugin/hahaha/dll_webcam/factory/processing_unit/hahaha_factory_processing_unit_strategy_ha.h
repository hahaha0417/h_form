...
class hahaha_processing_unit_strategy_webcam;
//---------------------------------------------------------------------------
...
public:
    ...
    std::map<hahaha::hahaha_processing_unit_strategy_webcam*, std::unique_ptr<hahaha::hahaha_processing_unit_strategy_webcam>> Pu_Strategy_Webcam_;
public:
