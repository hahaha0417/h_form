...
#include "hahaha_processing_unit_strategy_form.h"
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_form::hahaha_processing_unit_strategy_form()
{
	Reset();
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_form::hahaha_processing_unit_strategy_form(const hahaha_processing_unit_strategy_form& hpusf)
{
    Reset();
    hahaha::hahaha_processing_unit_strategy_form::Copy(hpusf);
	Copy(hpusf);
}
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_form::hahaha_processing_unit_strategy_form(hahaha_processing_unit_strategy_form&& hpusf) noexcept
{
    hahaha::hahaha_processing_unit_strategy_form::Move(std::move(hpusf));
    Move(std::move(hpusf));
}
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_form& hahaha_processing_unit_strategy_form::operator=(const hahaha_processing_unit_strategy_form& hpusf)
{
    hahaha::hahaha_processing_unit_strategy_form::Copy(hpusf);
	Copy(hpusf);
...
//---------------------------------------------------------------------------
hahaha_processing_unit_strategy_form& hahaha_processing_unit_strategy_form::operator=(hahaha_processing_unit_strategy_form&& hpusf) noexcept
{
    hahaha::hahaha_processing_unit_strategy_form::Move(std::move(hpusf));
    Move(std::move(hpusf));
...
//---------------------------------------------------------------------------
void hahaha_processing_unit_strategy_form::Copy(const hahaha_processing_unit_strategy_form& hpusf)
{

}
//---------------------------------------------------------------------------
void hahaha_processing_unit_strategy_form::Move(hahaha_processing_unit_strategy_form&& hpusf) noexcept
{
    File_Name_ = std::move(hpusf.File_Name_);

    Message_Create_ = std::move(hpusf.Message_Create_);


    Ratio_Fix_ = hpusf.Ratio_Fix_;
    Direction_ = hpusf.Direction_;
    Is_Load_Bitmap_ = hpusf.Is_Load_Bitmap_;

    Bitmap_Load_ = std::move(hpusf.Bitmap_Load_);
    Bitmap_ = std::move(hpusf.Bitmap_);
    Bitmap_Thumbnail_ = std::move(hpusf.Bitmap_Thumbnail_);

}
//---------------------------------------------------------------------------
int hahaha_processing_unit_strategy_form::Reset()
{
    Type_Strategy_ = ha_def::processing_unit_strategy::PLUGIN_HAHAHA_FORM;
    Name_Strategy_ = L"plugin_hahaha_form";

    Ratio_Fix_ = false;
    Direction_ = ha_def::processing_unit_strategy_direction::NORMAL;

    Message_Create_ = L"建立視窗框";
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Set_Parameter()
{
    ha::Form_Processing_Unit_Strategy_Form_->Is_Update = true;
    ha::Form_Processing_Unit_Strategy_Form_->text_image_path->Text = File_Name_.c_str();
    ha::Form_Processing_Unit_Strategy_Form_->check_fix_ratio->Checked = Ratio_Fix_;
    ha::Form_Processing_Unit_Strategy_Form_->combo_box_direction->ItemIndex = (int)Direction_;

    ha::Form_Processing_Unit_Strategy_Form_->Is_Update = false;
    return halib_def::result::SUCCESS;
}
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Get_Parameter()
{
    ha::Form_Processing_Unit_Strategy_Form_->Is_Update = true;
    if(File_Name_ == L"" || File_Name_ != ha::Form_Processing_Unit_Strategy_Form_->text_image_path->Text.c_str())
    {
        Is_Load_Bitmap_ = false;
    }
    File_Name_ = ha::Form_Processing_Unit_Strategy_Form_->text_image_path->Text.c_str();

    Ratio_Fix_ = ha::Form_Processing_Unit_Strategy_Form_->check_fix_ratio->Checked;
    Direction_ = (ha_def::processing_unit_strategy_direction)ha::Form_Processing_Unit_Strategy_Form_->combo_box_direction->ItemIndex;
...
halib_def::image_view_result hahaha_processing_unit_strategy_form::On_Mouse_Down_Design(halib::image_view& image_view,
    TObject *Sender,
    TMouseButton Button,
    TShiftState Shift,
    int X,
...
halib_def::image_view_result hahaha_processing_unit_strategy_form::On_Mouse_Move_Design(halib::image_view& image_view,
    TObject *Sender,
    TShiftState Shift,
    int X,
    int Y
...
halib_def::image_view_result hahaha_processing_unit_strategy_form::On_Mouse_Up_Design(halib::image_view& image_view,
    TObject *Sender,
    TMouseButton Button,
    TShiftState Shift,
    int X,
...
halib_def::image_view_result hahaha_processing_unit_strategy_form::On_Paint_Begin(halib::image_view& image_view)
{
    Thahaha_image_view_form* form_ = (Thahaha_image_view_form*)image_view.Form_Image_View_;
...
halib_def::image_view_result hahaha_processing_unit_strategy_form::On_Paint_Design(halib::image_view& image_view)
{
    Thahaha_image_view_form* form_ = (Thahaha_image_view_form*)image_view.Form_Image_View_;
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Prepare_Node(
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Prepare_Attribute(
    hahahalib::hahaha_parameter_deal_xml& xml,
    std::vector<std::wstring>& node_names,
    std::vector<std::wstring>& node_names_target,
    hahahalib::hahaha_parameter_deal_xml_node& root,
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Prepare_Value(
    hahahalib::hahaha_parameter_deal_xml& xml,
    std::vector<std::wstring>& node_names,
    std::vector<std::wstring>& node_names_target,
    hahahalib::hahaha_parameter_deal_xml_node& root,
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Prepare(
    hahahalib::hahaha_parameter_deal_xml& xml,
    std::vector<std::wstring>& node_names,
    hahahalib::hahaha_parameter_deal_xml_node& root
)
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Mapping(
    hahahalib::hahaha_parameter_deal_xml& xml,
    std::vector<std::wstring>& node_names,
    hahahalib::hahaha_parameter_deal_xml_node& root
)
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Initial()
{
    halib_def::result result = halib_def::result::SUCCESS;
...
//---------------------------------------------------------------------------
halib_def::result hahaha_processing_unit_strategy_form::Load_Initial()
{
    halib_def::result result = halib_def::result::SUCCESS;
