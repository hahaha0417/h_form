...
#ifndef hahaha_processing_unit_strategy_formH
#define hahaha_processing_unit_strategy_formH
//---------------------------------------------------------------------------
#pragma once
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
...
class hahaha_processing_unit_strategy_form : public hahaha::hahaha_processing_unit_strategy
{
public:
	hahaha_processing_unit_strategy_form();
	~hahaha_processing_unit_strategy_form();

	hahaha_processing_unit_strategy_form(const hahaha_processing_unit_strategy_form& hpusf);
    hahaha_processing_unit_strategy_form(hahaha_processing_unit_strategy_form&& hpusf) noexcept;
	hahaha_processing_unit_strategy_form& operator=(const hahaha_processing_unit_strategy_form& hpusf);
    hahaha_processing_unit_strategy_form& operator=(hahaha_processing_unit_strategy_form&& hpusf) noexcept;
	void Copy(const hahaha_processing_unit_strategy_form& hpusf);
    void Move(hahaha_processing_unit_strategy_form&& hpusf) noexcept;
public:
	int Reset();
