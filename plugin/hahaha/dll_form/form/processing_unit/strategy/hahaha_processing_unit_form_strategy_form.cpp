...
#include "hahaha_processing_unit_form_strategy_form.h"
//---------------------------------------------------------------------------
#pragma package(smart_init)
#pragma resource "*.dfm"
Thahaha_form_processing_unit_strategy_form *hahaha_form_processing_unit_strategy_form;
//---------------------------------------------------------------------------
__fastcall Thahaha_form_processing_unit_strategy_form::Thahaha_form_processing_unit_strategy_form(TComponent* Owner)
	: TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall Thahaha_form_processing_unit_strategy_form::button_minClick(TObject *Sender)
...
void __fastcall Thahaha_form_processing_unit_strategy_form::button_maxClick(TObject *Sender)
...
void __fastcall Thahaha_form_processing_unit_strategy_form::button_closeClick(TObject *Sender)
...
void __fastcall Thahaha_form_processing_unit_strategy_form::text_image_pathDblClick(TObject *Sender)
...
void __fastcall Thahaha_form_processing_unit_strategy_form::check_fix_ratioClick(TObject *Sender)
...
void __fastcall Thahaha_form_processing_unit_strategy_form::combo_box_directionChange(TObject *Sender)
