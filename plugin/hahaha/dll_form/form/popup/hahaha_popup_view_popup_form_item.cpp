	...
	: TForm(Owner)
{
    ...
    item_rect_form_box->BorderStyle = bsNone;
...
void __fastcall Thahaha_form_popup_view_popup_item::button_add_rect_formClick(TObject *Sender)

{
    ...
    item_rect_form_box->Visible = true;
    item_rect_form_box->Width++;
    ha::Structure_Main_->Form_Popup_View_Popup_->View_Name->Text = L"µøµ¡";

    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Base->Caption = L"ha";
    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Region->Caption = L"¯x§Î";
    ha::Structure_Main_->Form_Popup_View_Popup_->Label_Type_Strategy->Caption = L"µøµ¡";
    ...
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Factory_Strategy_ = ha_def::factory_processing_unit_strategy::PLUGIN_HAHAHA_FORM;
    ...
    ha::Structure_Main_->Form_Popup_View_Popup_->Type_Strategy_ = ha_def::processing_unit_strategy::PLUGIN_HAHAHA_FORM;
}
//---------------------------------------------------------------------------
