...
class hahaha_processing_unit_strategy_form;
//---------------------------------------------------------------------------
...
public:
    ...
    std::map<hahaha::hahaha_processing_unit_strategy_form*, std::unique_ptr<hahaha::hahaha_processing_unit_strategy_form>> Pu_Strategy_Form_;
public:
