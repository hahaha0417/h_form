...
#include <processing_unit\strategy\hahaha_processing_unit_strategy_form.h>
...
{
    Pu_Strategy_Form_ = std::move(hfpush.Pu_Strategy_Form_);
}
//---------------------------------------------------------------------------
...
{
    if(type == ha_def::processing_unit_strategy::PLUGIN_HAHAHA_FORM)
    {
        std::unique_ptr<hahaha::hahaha_processing_unit_strategy_form> pusf_;
        pusf_.reset(new hahaha::hahaha_processing_unit_strategy_form);
        // 這要在前
        processing_unit_strategy = pusf_.get();

        processing_unit_strategy->Type_Factory_Strategy_ = ha_def::factory_processing_unit_strategy::PLUGIN_HAHAHA_FORM;
        processing_unit_strategy->Name_Factory_Strategy_ = L"plugin_hahaha_form";
        //
        Pu_Strategy_Form_.insert(
        	std::pair<hahaha::hahaha_processing_unit_strategy_form*, std::unique_ptr<hahaha::hahaha_processing_unit_strategy_form>>(
            	pusf_.get(), std::move(pusf_)
            )
        );
    }
...
{
    if(processing_unit_strategy->Type_Strategy_ == ha_def::processing_unit_strategy::PLUGIN_HAHAHA_FORM)
    {
        Pu_Strategy_Form_.erase((hahaha::hahaha_processing_unit_strategy_form*)processing_unit_strategy);
    }
