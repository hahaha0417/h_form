...
#ifndef hahaha_view_form_viewH
#define hahaha_view_form_viewH
//---------------------------------------------------------------------------
#pragma once
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class Thahaha_form_view_view : public TForm
{
__published:	// IDE-managed Components
	...
	TScrollBox *main_box;
	TScrollBox *sub_box;
	TImage *image_visible;
	TImage *image_action;
	TImage *image_enabled;
	TImage *image_enabled_on;
	TImage *image_enabled_off;
	TImage *image_action_on;
	TImage *image_action_off;
	TImage *image_visible_on;
	TImage *image_visible_off;
...
public:		// User declarations
	__fastcall Thahaha_form_view_view(TComponent* Owner);
public:
public:
	//---------------------------------------------------------------------------
	int Set_Structure(
...
public:
public:
    hahaha::hahaha_view_view* View_;
public:
    bool Down_Item_;
};
//---------------------------------------------------------------------------
extern PACKAGE Thahaha_form_view_view *hahaha_form_view_view;
//---------------------------------------------------------------------------
#endif
