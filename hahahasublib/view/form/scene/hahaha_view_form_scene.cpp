...
#include <filesystem>
//---------------------------------------------------------------------------
#include "hahaha_view_form_scene.h"
//---------------------------------------------------------------------------
...
#else
	#pragma resource "hahaha_view_form_scene.dfm"
#endif

//#pragma resource "*.dfm"
Thahaha_form_view_scene *hahaha_form_view_scene;
//---------------------------------------------------------------------------
__fastcall Thahaha_form_view_scene::Thahaha_form_view_scene(TComponent* Owner)
	: TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall Thahaha_form_view_scene::button_minClick(TObject *Sender)
...
void __fastcall Thahaha_form_view_scene::button_maxClick(TObject *Sender)
...
void __fastcall Thahaha_form_view_scene::button_closeClick(TObject *Sender)
...
void __fastcall Thahaha_form_view_scene::ItemEnter(TObject *Sender)
{
    if(Scene_->Select_ || Down_Item_)
    {
...
void __fastcall Thahaha_form_view_scene::ItemLeave(TObject *Sender)
{
    if(Scene_->Select_ || Down_Item_)
    {
        item_box->Color = (TColor)RGB(180, 180, 180);
...
void __fastcall Thahaha_form_view_scene::ItemDown(TObject *Sender, TMouseButton Button,
...
void __fastcall Thahaha_form_view_scene::ItemUp(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
    Down_Item_ = false;
//    item_box->Color = (TColor)RGB(60, 60, 60);
...
int Thahaha_form_view_scene::Set_Structure(
...
int Thahaha_form_view_scene::Set_Pointer(
