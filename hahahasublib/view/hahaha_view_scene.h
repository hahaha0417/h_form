...
#ifndef hahaha_view_sceneH
#define hahaha_view_sceneH
//---------------------------------------------------------------------------
#pragma once
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
...
public:
	...
	hahaha_view_scene(const hahaha_view_scene& hpus);
	hahaha_view_scene operator=(const hahaha_view_scene& hpus);
	void Copy(const hahaha_view_scene& hpus);
public:
	int Reset();

public:
    std::vector<std::unique_ptr<hahaha::hahaha_view_view>> Views_;
public:
    std::wstring Name_;
public:
    halib_def::result Add_View(const std::wstring& name);
    halib_def::result Delete_View(const int& index);
...
public:
    ...
    //---------------------------------------------------------------------------
	std::unique_ptr<hahaha_view_scene_package> Package_;
public:
    bool Select_;
};
